...
export default function SignIn() {
  ...
  //Quando error o user cambiano viene eseguito ciò che c'è di seguito
  //se il corpo di React.useEffect viene messo sotto await loginUser(username, password) funziona al secondo submit.
  React.useEffect(() => {
    if (error) {
      console.log(error);
    }
