...
describe('UserRepository', () => {
    ...
    describe('getUserByUsername', () => {
        it('should return a user', async () => {
            ...
            expect(
                await userRepository.getUserByUsername(userEntityMock.username),
    ...
    describe('registerUser', () => {
        it('should return the registered user', async () => {
            ...
            expect(await userRepository.registerUser(userEntityMock)).toEqual(
                userEntityMock,
            );
        });
    });
